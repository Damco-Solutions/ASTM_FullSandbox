(function(skuid){
skuid.snippet.register('sendActOnEmail',function(args) {var contact = skuid.model.map().Contact.data[0];
console.log(sforce.connection.partnerServerUrls);
invokeWithActOnUrl( function(url) 
{ 
url += '/acton/sforce/sendSforceContactOrLead.jsp?id='+contact.Id+'&server='+sforce.connection.partnerServerUrls[19]+'&session='+skuid.utils.userInfo.sessionId;
