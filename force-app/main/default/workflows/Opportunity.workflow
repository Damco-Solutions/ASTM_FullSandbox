...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Send_Approved_Email_for_TechStreet_Account</fullName>
        <description>Send Approved Email for TechStreet Account</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/TechStreet_Approval_Accepted</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>Send_Denied_Email_to_Tech_Street</fullName>
        <description>Send Denied Email to Tech Street</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/TechStreet_Approval_Denied</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>TechStreet_Approval_Request_Notification</fullName>
        <description>TechStreet Approval Request Notification</description>
        <protected>false</protected>
        <recipients>
            <type>accountOwner</type>
        </recipients>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/TechStreet_Approval_Request_New</template>
    </alerts>
    <fieldUpdates>
